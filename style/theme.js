...
._2NQFL{color:#333;position:fixed;left:0;bottom:0;width:100%;font-family:verdana,sans-serif;font-size:12px;z-index:2147483647}._2WhLL{cursor:pointer;border:1px solid #bbb;border-radius:3px 3px 0 0;display:inline-block;margin-bottom:-1px;margin-left:1px;padding:3px 5px;pointer-events:all}._2WhLL,.yt7l_{background-color:#fff}.yt7l_{height:320px;position:relative;border:1px solid #bbb;top:0}._26ou5{display:block;border-color:#f0f0f0;border-bottom:1px solid;font-family:monospace;overflow-x:hidden;text-overflow:ellipsis;padding:3px 3px 3px 95px;white-space:nowrap}._26ou5._1LtKg{background-color:#fff0f0;color:red;border-color:#ffd6d6}._26ou5._2m5lQ{background-color:#fff;border-color:#f0f0f0}._26ou5._1JIMv{border-color:#e2f3ff;background-color:#f7fcff}._26ou5.V11dV{background-color:#fffbe5;color:#5c3c00;border-color:#fff5c2}._1bkkn{position:absolute;top:0;bottom:20px;overflow-y:auto;width:100%}.yY_XX{margin-left:-90px;color:grey}._1XaTW,.yY_XX{padding-right:5px}._1XaTW{white-space:nowrap}._1XaTW._3y5Jj{padding-left:10px;background:url("data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMCIgaGVpZ2h0PSIxMCI+PHBhdGggZmlsbD0iIzcyNzI3MiIgZD0iTTMgMmw1IDMtNSA0eiIvPjwvc3ZnPg==") no-repeat;background-position-y:2px}._1XaTW._3y5Jj._1vjYa{white-space:pre;background-image:url("data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSIxMCIgaGVpZ2h0PSIxMCI+PHBhdGggZmlsbD0iIzcyNzI3MiIgZD0iTTIgM2g2TDUgOXoiLz48L3N2Zz4=")}._1XaTW._3y5Jj:hover{background-color:rgba(241,255,255,.53)}._3Wpbj{background-color:inherit;padding:0 5px;color:grey}._3Wpbj,._10UzE{position:absolute;right:0}._10UzE{display:block;bottom:0;left:0}._1udxj{font-size:1.5em;font-weight:700;line-height:1;padding-left:5px;position:absolute}._1udxj,._1Uyei{font-family:monospace}._1Uyei{padding-left:20px;width:100%}
        html,
        body {
          padding: 0;
          margin: 0;
